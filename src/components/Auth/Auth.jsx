...
const OPTIONS = [
        { key: '1', content: 'Первый', email: 'user1@mail.ru', password: 'Testpassword'},
        { key: '2', content: 'Второй', email: 'user2@mail.ru', password: 'Testpassword' },
        { key: '3', content: 'Третий', email: 'user3@mail.ru', password: 'Testpassword' },
        { key: '4', content: 'Четвёртый', email: 'user4@mail.ru', password: 'Testpassword' },
        { key: '5', content: 'Пятый', email: 'user5@mail.ru', password: 'Testpassword' },
        { key: '6', content: 'Шестой', email: 'user6@mail.ru', password: 'Testpassword' },
        { key: '7', content: 'Седьмой', email: 'user7@mail.ru', password: 'Testpassword' },
        { key: '8', content: 'Восьмой', email: 'qweqwe@example.com', password: 'Testpassword' },
    ];
