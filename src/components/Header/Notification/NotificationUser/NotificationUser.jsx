...
export default function NotificationUser(showDropDown) {
  ...
  useEffect(() => {
    ...
    // Cleanup function to restore overflow to its original state
    return () => {
      document.body.style.overflow = 'auto';
    };
  }, [showDropDown]);
  return (
    <>
      <div className={style.cardNotification}>
        ...
        <p className={style.textNotifi}>Вам создан новый <span className={style.textNotifi_blue}>план развития.</span></p>
      </div>
      <div className={style.cardNotification}>
        <div className={style.user}>
          <div className={style.photoURL}>
        ...
        <p className={style.textNotifi}>
          В ваш план развития добавлена <span className={style.textNotifi_blue}>новая задача.</span>
        </p>
      </div>
      <div className={style.cardNotification}>
        <div className={style.user}>
        ...
        <p className={style.textNotifi}>
          Ваша <span className={style.textNotifi_blue}>задача</span> возвращена на доработку.
        </p>
      </div>
    </>
  );
